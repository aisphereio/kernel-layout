...
func (x *TodoService_SyncTodosHTTPServer) Recv() (*SyncTodosRequest, error) {
	m := new(SyncTodosRequest)
...
func (x *TodoService_SyncTodosHTTPClient) open(m *SyncTodosRequest) error {
...
func (x *TodoService_SyncTodosHTTPClient) Send(m *SyncTodosRequest) error {
