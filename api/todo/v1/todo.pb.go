...
const file_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x12todo/v1/todo.proto\x12\atodo.v1\x1a\x1faisphere/access/v1/access.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xde\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\n" +
	"CreateTodo\x12\x1a.todo.v1.CreateTodoRequest\x1a\r.todo.v1.Todo\"\x82\x01\x92\xf4\x18`\b\x03\x12)\n" +
	"\x06create\x12\x0ftodo:collection\x1a\ftodo-service \x01\x1a\x14\b\x01\x12\vtodo.create\x1a\x03low\"\x1b\b\x01\x12\tprincipal\x19\x00\x00\x00\x00\x00\x00Y@ \xc8\x01(\x01\x82\xd3\xe4\x93\x02\x18:\x04todo\"\x10/v1/todos/create\x12\xa2\x01\n" +
	"\aGetTodo\x12\x17.todo.v1.GetTodoRequest\x1a\r.todo.v1.Todo\"o\x92\xf4\x18U\b\x03\x12!\n" +
	"\x04read\x12\ttodo:{id}\x1a\ftodo-service \x01\x1a\x11\b\x01\x12\btodo.get\x1a\x03low\"\x1b\b\x01\x12\tprincipal\x19\x00\x00\x00\x00\x00\x00Y@ \xc8\x01(\x01\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/todos/{id}\x12\xb0\x01\n" +
	"\tListTodos\x12\x19.todo.v1.ListTodosRequest\x1a\x10.todo.v1.TodoSet\"v\x92\xf4\x18\\\b\x03\x12'\n" +
	"\x04read\x12\x0ftodo:collection\x1a\ftodo-service \x01\x1a\x12\b\x01\x12\ttodo.list\x1a\x03low\"\x1b\b\x01\x12\tprincipal\x19\x00\x00\x00\x00\x00\x00Y@ \xc8\x01(\x01\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/todos/list\x12\xbd\x01\n" +
	"\n" +
	"UpdateTodo\x12\x1a.todo.v1.UpdateTodoRequest\x1a\r.todo.v1.Todo\"\x83\x01\x92\xf4\x18a\b\x03\x12(\n" +
	"\x06update\x12\x0etodo:{todo.id}\x1a\ftodo-service \x01\x1a\x17\b\x01\x12\vtodo.update\x1a\x06medium\"\x1a\b\x01\x12\tprincipal\x19\x00\x00\x00\x00\x00\x00I@ d(\x01\x82\xd3\xe4\x93\x02\x18:\x04todo\x1a\x10/v1/todos/update\x12\xb6\x01\n" +
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x16.google.protobuf.Empty\"t\x92\xf4\x18Z\b\x03\x12#\n" +
	"\x06delete\x12\ttodo:{id}\x1a\ftodo-service \x01\x1a\x15\b\x01\x12\vtodo.delete\x1a\x04high\"\x1a\b\x01\x12\tprincipal\x19\x00\x00\x00\x00\x00\x004@ ((\x01\x82\xd3\xe4\x93\x02\x10*\x0e/v1/todos/{id}\x12\xb8\x01\n" +
	"\n" +
